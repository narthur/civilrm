                ...
                <form onSubmit={handleUpdateProfile} className="space-y-6">
                  <div>
                    ...
                    <input
                      ...
                      required
                      className="w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 text-gray-200 placeholder:text-gray-400"
                    />
                  </div>
                  <div>
                    <label
